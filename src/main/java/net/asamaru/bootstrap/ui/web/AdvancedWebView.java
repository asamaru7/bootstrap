package net.asamaru.bootstrap.ui.web;
...
public class AdvancedWebView extends WebView {
	 ...
	 */
	protected static final String[] ALTERNATIVE_BROWSERS = new String[]{"org.mozilla.firefox", "com.android.chrome", "com.opera.webView", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.webView.beta"};
	...
	public static class Browsers {
		...
		/**
		 * Package name of an alternative webView that is installed on this device
		 */
		private static String mAlternativePackage;

		/**
		 * Returns whether there is an alternative webView with its own rendering engine currently installed
		 *
		 * @param context a valid `Context` reference
		 * @return whether there is an alternative webView or not
		 */
		...
		/**
		 * Returns the package name of an alternative webView with its own rendering engine or `null`
		 *
		 * @param context a valid `Context` reference
		...
		/**
		 * Opens the given URL in an alternative webView
		 *
		 ...
		 * @param context           a valid `Activity` reference
		 * @param url               the URL to open
		 * @param withoutTransition whether to switch to the webView `Activity` without a transition
		 */
